...
--
-- Anamakine: localhost
-- Üretim Zamanı: 28 Eyl 2024, 00:18:26
-- Sunucu sürümü: 8.3.0
-- PHP Sürümü: 8.3.8
...
--
-- Tablo için tablo yapısı `book_libraries`
--
...
--
-- Tablo için tablo yapısı `libraries`
--
...
--
-- Tablo için indeksler `book_libraries`
--
ALTER TABLE `book_libraries`
  ADD PRIMARY KEY (`id`),
  ADD KEY `book_libraries_book_id_foreign` (`book_id`);
...
--
-- Tablo için indeksler `libraries`
--
...
ALTER TABLE `versions`
  ...
  ADD KEY `versions_versionable_id_index` (`versionable_id`);
...
--
-- Tablo için AUTO_INCREMENT değeri `book_libraries`
--
ALTER TABLE `book_libraries`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `libraries`
--
ALTER TABLE `libraries`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Tablo kısıtlamaları `book_categories`
--
ALTER TABLE `book_categories`
  ADD CONSTRAINT `book_categories_book_id_foreign` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE;

--
-- Tablo kısıtlamaları `book_libraries`
--
ALTER TABLE `book_libraries`
  ADD CONSTRAINT `book_libraries_book_id_foreign` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE;
COMMIT;
